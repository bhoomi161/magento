...
class Ccc_Custom_Block_Adminhtml_Custom_Attribute_Set_Main_Formgroup extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $form->setMethod('post');
        $form->setAction($this->getUrl('*/custom_group/save'));
        $this->setForm($form);
    }
