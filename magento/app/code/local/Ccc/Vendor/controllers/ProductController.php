        ...
        if ($postData = $this->getRequest()->getPost()) {
            try {
                ...
                if($vendorProductModel->getId()){
                    ...
                    $session->setData($productId,$vendorProductModel->getData());
                   ...
                   // Mage::register($productId,$vendorProductModel->getData());
                ...
                $sql = "update `vendor_product` set vendor_id = $vendorId where entity_id = $entityId";
                $conn->query($sql);
