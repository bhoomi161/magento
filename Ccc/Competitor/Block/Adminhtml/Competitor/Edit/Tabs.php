...
class Ccc_Competitor_Block_Adminhtml_Competitor_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    public function __construct()
    {
      ...
      $this->setTitle(Mage::helper('competitor')->__('Competitor Information'));
    }
    
    public function getCompetitor()
    {
        if (!($this->getData('competitor') instanceof Ccc_Competitor_Model_Competitor)) {
            $this->setData('competitor', Mage::registry('current_competitor'));
        }
        return $this->getData('competitor');
    }
