...
class Ccc_Competitor_Model_Resource_Attribute extends Mage_Eav_Model_Resource_Entity_Attribute{
    ...
    public function deleteEntity(Mage_Core_Model_Abstract $object)
    {
        ...
        if ($result) {
            $attribute = Mage::getSingleton('eav/config')
                ->getAttribute(Ccc_Competitor_Model_Competitor::ENTITY, $result['attribute_id']);
