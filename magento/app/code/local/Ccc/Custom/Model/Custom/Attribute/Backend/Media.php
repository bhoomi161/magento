<?php
// class Ccc_Custom_Model_Custom_Attribute_Backend_Media extends Mage_Eav_Model_Entity_Attribute_Backend_Abstract
// {
...
//         Mage::dispatchEvent('custom_media_save_before', array('custom' => $object, 'images' => $value));
...
//         $images = Mage::getResourceModel('custom')
...
//     }
//     public function addImage(Ccc_Custom_Model_Custom $custom, $file,
//         $mediaAttribute = null, $move = false, $exclude = true)
//     {
//         $file = realpath($file);

//         if (!$file || !file_exists($file)) {
//             Mage::throwException(Mage::helper('custom')->__('Image does not exist.'));
//         }

//         Mage::dispatchEvent('custom_media_add_image', array('custom' => $custom, 'image' => $file));

//         $pathinfo = pathinfo($file);
//         $imgExtensions = array('jpg','jpeg','gif','png');
//         if (!isset($pathinfo['extension']) || !in_array(strtolower($pathinfo['extension']), $imgExtensions)) {
//             Mage::throwException(Mage::helper('custom')->__('Invalid image file type.'));
//         }
...
//         }
//         catch (Exception $e) {
//             Mage::throwException(Mage::helper('custom')->__('Failed to move file: %s', $e->getMessage()));
//         }

//         $fileName = str_replace(DS, '/', $fileName);

//         $attrCode = $this->getAttribute()->getAttributeCode();
//         $mediaGalleryData = $custom->getData($attrCode);
//         $position = 0;
...
//         $custom->setData($attrCode, $mediaGalleryData);

//         if (!is_null($mediaAttribute)) {
//             $this->setMediaAttribute($custom, $mediaAttribute, $fileName);
//         }

//         return $fileName;
//     }

//     public function addImagesWithDifferentMediaAttributes(Ccc_Custom_Model_Custom $custom,
...
//                 $savedFileName = $this->addImage($custom, $filePath . $value['file'], null, $move, $exclude);
...
//                 $this->setMediaAttribute($custom, $value['mediaAttribute'], $savedFileName);
//             }
...
//     }
//     public function updateImage(Ccc_Custom_Model_Custom $custom, $file, $data)
//     {
//         $fieldsMap = array(
//             'label'    => 'label',
//             'position' => 'position',
...
//     public function removeImage(Ccc_Custom_Model_Custom $custom, $file)
//     {
//         $attrCode = $this->getAttribute()->getAttributeCode();
...
//     public function getImage(Ccc_Custom_Model_Custom $custom, $file)
//     {
//         $attrCode = $this->getAttribute()->getAttributeCode();
//         $mediaGalleryData = $custom->getData($attrCode);
//         if (!isset($mediaGalleryData['images']) || !is_array($mediaGalleryData['images'])) {
...
//     public function clearMediaAttribute(Ccc_Custom_Model_Custom $custom, $mediaAttribute)
//     {
//         $mediaAttributeCodes = array_keys($custom->getMediaAttributes());

//         if (is_array($mediaAttribute)) {
//             foreach ($mediaAttribute as $atttribute) {
//                 if (in_array($atttribute, $mediaAttributeCodes)) {
//                     $custom->setData($atttribute, null);
//                 }
//             }
//         } elseif (in_array($mediaAttribute, $mediaAttributeCodes)) {
//             $custom->setData($mediaAttribute, null);
//         }
...
//     public function setMediaAttribute(Ccc_Custom_Model_Custom $custom, $mediaAttribute, $value)
//     {
//         $mediaAttributeCodes = array_keys($custom->getMediaAttributes());
...
//             foreach ($mediaAttribute as $atttribute) {
//                 if (in_array($atttribute, $mediaAttributeCodes)) {
//                     $custom->setData($atttribute, $value);
//                 }
//             }
//         } elseif (in_array($mediaAttribute, $mediaAttributeCodes)) {
//             $custom->setData($mediaAttribute, $value);
//         }
...
//     {
//         return Mage::getResourceSingleton('custom/custom_attribute_backend_media');
//     }


//     protected function _getConfig()
//     {
//         return Mage::getSingleton('custom/media_config');
//     }
...
//                 ->getUniqueFilename(
//                     Mage::getSingleton('custom/media_config')->getBaseMediaUrlAddition(),
//                     $file
//                 );
//         } else {
